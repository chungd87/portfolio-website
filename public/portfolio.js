...
portfolio_link.addEventListener("click", function (event) {
    ...
    <div class = "container" style = "overflow-x: scroll; min-width: 900px;">\
        <div class = "row flex-nowrap" style="min-height: 400px; max-height: 800px; min-width: 900px; overflow-x: auto;">\
            <div class="col-3">\
                <div class="card card-block" style = "margin: 5px; background-color: #f2f2f2;">\
                    <a target="_blank" href="https://drive.google.com/file/d/1VffSXJHp-0ms7LzL83DH0zxcMvejkF0f/view?usp=sharing">\
                        <img style = "max-width: 274px; max-height: 155px;" class="card-img-top" src="./public/project1.png" alt="Card image cap"></a>\
                    <div class="card-body">\
                        <h5 class="card-title">D&D Character Sheet App</h5><br>\
                        ...
                        Simple local database interaction with SQLite.</p>\
            ...
            <div class="col-3">\
                <div class="card card-block" style = "margin: 5px; background-color: #f2f2f2;">\
                    <a target="_blank" href="https://drive.google.com/file/d/1_glZsw1_kuUWNIsuoJKjGDzGprRcNwit/view?usp=sharing">\
                        <img style = "max-width: 274px; max-height: 155px;" class="card-img-top" src="./public/project2.png" alt="Card image cap"></a>\
                    <div class="card-body">\
                        <h5 class="card-title">Movie Studio Database WebApp</h5>\
                        ...
                        Database interaction with MySQL, display of data with Express. Javascript and Node. Collaborative partner project (Danny Chung and Hailee Hibray).</p>\
            ...
            <div class="col-3">\
                <div class="card card-block" style = "margin: 5px; background-color: #f2f2f2;">\
                        <img style = "max-width: 274px; max-height: 155px;" class="card-img-top" src="./public/soon.png" alt="Card image cap">\
                    <div class="card-body">\
            ...
            <div class="col-3">\
                <div class="card card-block" style = "margin: 5px; background-color: #f2f2f2;">\
                        <img style = "max-width: 274px; max-height: 155px;" class="card-img-top" src="./public/portfvidstillsmall.bmp" alt="Card image cap">\
                    <div class="card-body">\
                        <h5 class="card-title">Portfolio Website Code Repository</h5><br>\
                        <p class="card-text">Responsive front-end web development with BootStrap. DOM manipulation with JavaScript and styling of HTML markup with CSS.</p>\
                        <i id ="stackH" class="devicon-html5-plain-wordmark colored"></i>\
                        <i id ="stackCSS" class="devicon-css3-plain-wordmark colored"></i>\
                        <i id ="stackJS" class="devicon-javascript-plain colored"></i>\
